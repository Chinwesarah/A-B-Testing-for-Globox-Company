...
A/B testing for a new banner on the Company's mobile website to investigate its effect on revenue and conversion rate. This project demonstrates skills in A/B test design, statistical analysis, data visualisation, critical thinking, problem-solving, decision-making based on data insights, and project management. 
## Project Overview
